...
const ContextProvider = (props) => {
    ...
    if (IndexofItem === -1) {
      try {
        let response = await axios.post(
          `https://crudcrud.com/api/f0d94cb7bddf4f1dad0cb00dc2299c2d/cart${createnewEmail}`,
          item,
          {
            headers: {
      ...
      try {
        let response = await axios.put(
          `https://crudcrud.com/api/f0d94cb7bddf4f1dad0cb00dc2299c2d/cart${createnewEmail}/${copyItems[IndexofItem]._id}`,
          {
            id: item.id,
            title: item.title,
            price: item.price,
  ...
  async function removeItemsHandler(id) {
    ...
    if (items[ItemIndex].quantity > 1) {
      ...
      try {
        let response = await axios.put(
          `https://crudcrud.com/api/f0d94cb7bddf4f1dad0cb00dc2299c2d/cart${createnewEmail}/${copyArr[ItemIndex]._id}`,
          {
